 ...
 */
public class NeuLayout extends android.widget.LinearLayout {

    public NeuLayout(Context context) {
        super(context);
    }
    ...
    public NeuLayout(Context context, AttributeSet attrs, int defStyleAttr) {
